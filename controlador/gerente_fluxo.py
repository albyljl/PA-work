...
class GerenteFluxo:
    ...
    def colar_selecionadas(self):
        ...
        # Permite colagens consecutivas sempre deslocadas.
    ...
    def salvar_imagem_eps(self):
        ...
        try:
            ...
            messagebox.showinfo("Sucesso", "Desenho exportado como EPS.")
        except OSError as erro:
            messagebox.showerror("Erro", f"Erro ao exportar imagem: {erro}")
